...
export default function About() {
  ...
  const highlights = [
    { title: '5 Solid Years', desc: 'Supporting Australian, US, & global companies' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-[#14B8A6] font-display text-base sm:text-lg font-semibold tracking-wide leading-relaxed border-l-2 border-[#14B8A6] pl-4 italic">
                "Let me free you from the burden. I'm your Virtual Help — here so you don't have to carry it all alone."
              </p>
              <p className="text-[#9CA3AF] leading-relaxed text-sm sm:text-base pt-2">
                I am a results-driven Virtual Assistant and Social Media Manager with over 5 solid years of hands-on experience supporting businesses across Australia, the United States, and online organizations. I specialize in bridging the gap between high-level operations and daily tasks.
              </p>
