  ...
  return (
    <section id="testimonials" className="py-24 bg-[#0A0A0A] border-t border-[#262626] relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          {testimonialsList.map((item) => (
            ...
            >
              ...
              <div className="flex-grow mb-8">
                <p className="text-sm text-[#9CA3AF] leading-relaxed italic font-sans group-hover:text-[#F5F5F5] transition-colors duration-300 whitespace-pre-line">
                  "{item.testimonial}"
                </p>
              </div>
        ...
        {/* Brand Logos Strip below reviews/testimonials */}
