  ...
  const hubItems = [
    {
      ...
      accentColorClass: 'text-[#FACC15]',
      gradientBorder: 'from-[#14B8A6] via-[#FACC15] to-[#14B8A6]',
      badgeText: 'ME',
    ...
    },
    {
      ...
      gradientBorder: 'from-[#FACC15] via-[#14B8A6] to-[#FACC15]',
      badgeText: 'SMM',
    ...
    },
    {
      ...
      gradientBorder: 'from-[#14B8A6] via-[#FACC15] to-[#14B8A6]',
      badgeText: 'PRO',
      description: '5 solid years expert support'
    },
    {
      name: 'My Workflow (Admin)',
      viewId: 'workflow',
      icon: Workflow,
      accentIcon: Zap,
      iconColorClass: 'text-[#FACC15]',
    ...
    },
    {
      ...
      gradientBorder: 'from-[#14B8A6] via-[#FACC15] to-[#14B8A6]',
      badgeText: 'SOC',
      description: 'My SMM Client Lifecycle'
    },
    {
      name: 'Tools & Skills',
      viewId: 'tools',
    ...
    },
    {
      ...
      gradientBorder: 'from-[#FACC15] via-[#14B8A6] to-[#FACC15]',
      badgeText: 'TALK',
      description: 'Start a partnership'
    }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 w-full relative z-10 flex flex-col items-center text-center">
        ...
        {/* Hub Navigation Grid (2 cols mobile, 4 cols tablet/desktop) */}
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 sm:gap-5 w-full max-w-5xl mt-2 select-none animate-fade-in" id="hub-grid">
          {hubItems.map((item) => {
            ...
            return (
              <a
                ...
                className="group flex flex-col items-center justify-center p-5 rounded-lg bg-[#121212] border border-[#14B8A6] hover:border-[#14B8A6] transition-all duration-300 text-center relative overflow-hidden hover:scale-[1.03] cursor-pointer hover:shadow-[0_0_22px_rgba(20,184,166,0.3)]"
                style={{
              ...
              >
                ...
                {/* Custom Dual-Color Graphic Badge with Teal and Yellow */}
                <div className="relative z-10 mb-4 flex items-center justify-center">
                  {/* Subtle dynamic glow base */}
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-tr from-[#14B8A6]/20 to-[#FACC15]/20 blur-md opacity-70 group-hover:opacity-100 transition-opacity duration-300"></div>
                  
                  {/* Outer gradient-border container */}
                  <div className={`p-[1.5px] rounded-xl bg-gradient-to-tr ${item.gradientBorder} shadow-lg transition-transform duration-300 group-hover:scale-105`}>
                    
                    {/* Inner backdrop tile */}
                    <div className="relative bg-[#0F0F0F] group-hover:bg-[#1A1A1A] w-14 h-14 rounded-[11px] flex items-center justify-center transition-colors duration-300 overflow-hidden">
                      
                      {/* Secondary ambient tech visual lines in background */}
                      <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#14B8A6_1px,transparent_1px)] [background-size:8px_8px]"></div>
                      
                      {/* Primary Icon */}
                      <div className={`relative z-10 transition-all duration-300 transform group-hover:scale-110 ${item.iconColorClass} group-hover:text-black`}>
                        <IconComponent className="w-6 h-6 stroke-[2.25]" />
                      </div>

                      {/* Small floating secondary Accent Icon (opposing color of primary) in bottom-right corner */}
                      {item.accentIcon && (() => {
                        const AccentIconComponent = item.accentIcon;
                        return (
                          <div className={`absolute bottom-1 right-1 z-20 p-0.5 rounded-full bg-black/60 border border-[#262626] ${item.accentColorClass} transition-all duration-300 transform group-hover:translate-x-0.5 group-hover:translate-y-0.5 group-hover:scale-110`}>
                            <AccentIconComponent className="w-3 h-3 stroke-[2.5]" />
                          </div>
                        );
                      })()}

                      {/* Tiny stylized top-right indicator tag */}
                      <span className="absolute top-1 right-1 text-[8px] font-mono font-black text-[#FACC15] opacity-40 group-hover:opacity-90 transition-opacity">
                        {item.badgeText}
                      </span>
                    </div>
                  </div>
        ...
        >
          ...
          >
            ...
            <div className="flex gap-2.5 mb-4 justify-center w-full">
              {sampleHeadshots.map((sh, i) => (
                <button
                  ...
                  className="flex-1 py-2 bg-[#1A1A1A] hover:bg-[#14B8A6]/20 border border-[#14B8A6]/30 hover:border-[#14B8A6] rounded text-xs font-mono text-[#F5F5F5] transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
            ...
            <div className="mb-4">
              ...
              <div 
                className="border border-dashed border-[#14B8A6]/40 hover:border-[#14B8A6] rounded-lg p-4 bg-[#0A0A0A] hover:bg-[#121212] transition-all duration-300 text-center flex flex-col items-center justify-center gap-2 cursor-pointer relative group"
