...
export default function Portfolio() {
  const [activeFilter, setActiveFilter] = useState<'All' | 'Brand Kits' | 'Graphic Design' | 'Reels/Video' | 'Promotional'>('All');
  ...
  const filteredItems = portfolioItems.filter(item => {
    ...
    if (activeFilter === 'Graphic Design') return item.filter === 'graphic-design';
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-12 p-6 rounded-2xl bg-gradient-to-r from-[#121212] via-[#14B8A6]/5 to-[#121212] border border-[#14B8A6]/20 relative overflow-hidden group hover:border-[#14B8A6]/40 transition-all duration-300">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            ...
            <a
              href="https://drive.google.com/drive/folders/1mGQ2L0PvPm1d-VBo4K0BtcZY0_w2W5O9?usp=drive_link"
              target="_blank"
        ...
        <div className="flex flex-wrap gap-2.5 mb-10 pb-2 border-b border-[#262626]">
          {(['All', 'Brand Kits', 'Graphic Design', 'Reels/Video', 'Promotional'] as const).map((filter) => (
            <button
              key={filter}
          ...
          <div className="relative w-full max-w-4xl bg-[#1A1A1A] border border-[#262626] rounded-2xl overflow-hidden shadow-2xl z-10 grid grid-cols-1 md:grid-cols-12 max-h-[90vh] md:max-h-[80vh]">
            ...
            <div className="col-span-12 md:col-span-6 p-6 sm:p-8 flex flex-col justify-between overflow-y-auto">
              ...
              <div className="pt-8 mt-6 border-t border-[#262626] flex items-center justify-between gap-4">
                {selectedItem.filter === 'video' ? (
                  <a
                    href="https://drive.google.com/drive/folders/1OYSiqyiJrHy59di9jrSMVt8x3d5D_jx_?usp=drive_link"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full inline-flex items-center justify-center gap-2.5 px-6 py-3.5 text-xs font-bold uppercase tracking-wider text-[#0A0A0A] bg-[#14B8A6] hover:bg-[#0FB9B1] rounded-2xl transition-all duration-300 font-display shadow-lg shadow-[#14B8A6]/10 hover:shadow-[#14B8A6]/25"
                  >
